...
<?php
  ...
  while($row=mysqli_fetch_assoc($res)){
    echo "<tr><td data-table='theme' data-id='".$row["ID"]."'><a href='?m=themes&f=edittheme&nh=1&ID=".$row["ID"]."'>".$row["Name"]."</a><span class='edit ml-3'><i class='fas fa-pen-square'></i></span><span class='delete ml-1'><i class='fas fa-trash-alt'></i></span><span class='copy ml-1'><i class='fas fa-copy'></i></span></td></tr>";
  }
?>
</tbody>
</table>
